...
import { Table, Button, Typography, Tag, Modal, Pagination, message, Input, Tooltip, Alert } from 'antd';
import {
    PlusOutlined,
    DeleteOutlined,
    CheckCircleOutlined,
...
const QueueSource = () => {
    ...
    useEffect(() => {
        ...
        if (isInFirst === 'true')
        {
            ...
            message.info('The HubSpot source has been successfully connected!');
        }
    }, []);
    ...
    const fetchSources = () => {
        ...
        try
        {
            ...
            const sourcesData = [
                {
                    _id: parsed.hub_id,
                    name: `HubSpot[${parsed.hub_id}]`,
                    platform: {
                        name: parsed.platform_name,
                        type: 'CRM',
                    },
                    createdAt: parsed.installed_date,
                    isActive: true,
                },
            ];
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (isActive: boolean) => (
                ...
                >
                    {isActive ? 'Queue' : 'Ready for synchronization'}
                </Tag>
            ),
        },
        {
