...
const ConnectHubspot: React.FC = () => {
    ...
    const handleConnect = async () => {
        try
        {
            ...
            //     return;
            // }
            const oauthUrl = `https://app-na2.hubspot.com/oauth/authorize?client_id=ec608a84-8a8c-4f54-8696-2db8fab01752&redirect_uri=https://gdrive.nexce.com/fe/api/hubspot/callback&scope=crm.objects.contacts.write%20crm.objects.deals.read%20crm.objects.deals.write%20crm.objects.contacts.read`
