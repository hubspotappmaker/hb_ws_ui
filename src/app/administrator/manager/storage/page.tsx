...
import { getQueueSourceAccount } from "@/service/admin/account";
...
const StoragePage = () => {
    ...
    const fetchSourceAccounts = async () => {
        ...
        try
        {
            const response = await getQueueSourceAccount(currentPage, pageSize);
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (record: SourceAccount) => {
                ...
                return (
                    <Tag
                        color={record.isActive ? "green" : "green"}
                        icon={record.isActive ? <CheckCircleOutlined /> : <CheckCircleOutlined />}
                    >
                        {record.isActive ? 'Connected' : 'Queue'}
                    </Tag>
                );
            },
            width: 150,
    ...
    return (
        <PageContainer>
            <HeaderContainer>
                <StyledTitle level={2}>Source Storage</StyledTitle>
                <Space>
